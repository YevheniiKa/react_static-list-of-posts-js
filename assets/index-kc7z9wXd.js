...
aut aut aut maxime quia temporibus ut omnis`}],Pc=({user:e})=>O.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Lc=({comment:e})=>O.jsxs("div",{className:"CommentInfo",children:[O.jsxs("div",{className:"CommentInfo__title",children:[O.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",O.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),O.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Tc=({comments:e})=>O.jsx("div",{className:"CommentList",children:e.length>0?e.map(t=>O.jsx(Lc,{comment:t},t.id)):O.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})}),Mc=({post:e})=>O.jsxs("div",{className:"PostInfo",children:[O.jsxs("div",{className:"PostInfo__header",children:[O.jsx("h3",{className:"PostInfo__title",children:e.title}),O.jsxs("p",{children:["Posted by ",e.user&&O.jsx(Pc,{user:e.user})]})]}),O.jsx("p",{className:"PostInfo__body",children:e.body}),O.jsx("hr",{}),O.jsx(Tc,{comments:e.comments})]}),Rc=({posts:e})=>O.jsx("div",{className:"PostList",children:e.map(t=>O.jsx(Mc,{post:t},t.id))});function Dc(e){return zc.find(t=>t.id===e)}function jc(e){return Nc.filter(t=>t.postId===e)}const Oc=Cc.map(e=>({...e,user:Dc(e.userId),comments:jc(e.id)})),Fc=()=>O.jsxs("section",{className:"App",children:[O.jsx("h1",{className:"App__title",children:"Static list of posts"}),O.jsx(Rc,{posts:Oc})]});em(document.getElementById("root")).render(O.jsx(Fc,{}));
